...
// J - Adicionei 2 funções

// J - Calcula a distância entre 2 pontos da coordenada
    ...
    while (fgets(line, sizeof(line), fp_in)){
        ...
        for (int icont = 0; icont < quantidadePontos - 1; icont = icont + 1){
            for (int jcont = 0; jcont < quantidadePontos - icont - 1; jcont = jcont + 1){
                float d1 = distancia2Pontos(0, 0, listaOrdenada[jcont].pontoX, listaOrdenada[jcont].pontoY);
                float d2 = distancia2Pontos(0, 0, listaOrdenada[jcont + 1].pontoX, listaOrdenada[jcont + 1].pontoY);
                if (d1 > d2){
        ...
        // J - Verifica a distância dos pontos considerando a origem (0,0) e realiza a ordenação
        ...
        for (int icont = 0; icont < fquantidadePontos - 1; icont = icont + 1){
            for (int jcont = 0; jcont < fquantidadePontos - icont - 1; jcont = jcont + 1){
                float d1 = distancia2Pontos(0, 0, flistaOrdenada[jcont].pontoXf, flistaOrdenada[jcont].pontoYf);
                float d2 = distancia2Pontos(0, 0, flistaOrdenada[jcont + 1].pontoXf, flistaOrdenada[jcont + 1].pontoYf);
                if (d1 > d2){
